...
Clone this [repository](https://github.com/shubhambhoyar077/blog-app) to your desired folder.
...
- Clone this [repository](https://github.com/shubhambhoyar077/blog-app) in your local machine with correct branch.
- Run following cmds:-
- **rails db:create**
- **rails db:migrate**
- **rails s**
